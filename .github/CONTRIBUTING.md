# Contributing to mwamba-ui

Love mwamba-ui and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/athmangude/spring-board/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/athmangude/spring-board.git
   # Navigate to the newly cloned directory
   cd react-boilerplate
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/athmangude/spring-board.git
   ```
