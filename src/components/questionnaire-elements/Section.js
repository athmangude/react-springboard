...
const Section = ({ questions, onChange, responses, title, tag, type, messages, media, onNext, isLastSection }) => {
  ...
  function onValidSubmit() {
    ...
    return console.log('should submit');
  }
      ...
      }
      {
        type === 'questionnaire' ? (
          ...
          <>
            ...
            <Button variant="contained" color="secondary" type="submit" className="button-primary" onClick={onNext}>Proceed</Button>
          </>
        ) : null
      }
