          ...
          <ResponsiveContainer>
            {
              chartType === 'bar' ? (
                ...
                <LineChart data={data} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
                  ...
                  <Tooltip content={<CustomTooltip />} />
                  <Legend />
                  <Line type="linear" dataKey="incentives" stroke="#f26b50" strokeWidth={2} dot={{ stroke: '#f26b50', strokeWidth: 2, r: 4 }} />
                </LineChart>
              )
            }
          </ResponsiveContainer>
