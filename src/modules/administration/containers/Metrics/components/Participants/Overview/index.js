...
export default class Overview extends Component {
  ...
  render() {
    const { interval, chartType, isLoadingMetrics } = this.state;
    const data = {
      '2018-01-31': { incentives: 201 },
      '2018-02-28': { incentives: 201 },
      '2018-03-31': { incentives: 201 },
      '2018-04-30': { incentives: 201 },
      '2018-05-31': { incentives: 201 },
      '2018-06-30': { incentives: 201 },
      '2018-07-31': { incentives: 201 },
      '2018-08-31': { incentives: 201 },
      '2018-09-30': { incentives: 201 },
      '2018-10-31': { incentives: 201 },
      '2018-11-30': { incentives: 201 },
      '2018-12-31': { incentives: 201 },
    };

    const incentives = Object.values(data).reduce((accumulator, currentValue) => accumulator + currentValue.incentives, 0);
    ...
    const dataSchema = Object.keys(data).sort().map((key) => {
      ...
      return { period, incentives: data[key].incentives };
    });
