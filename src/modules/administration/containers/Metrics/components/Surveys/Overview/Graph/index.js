          ...
          <ResponsiveContainer>
            {
              chartType === 'bar' ? (
                <BarChart barCategoryGap={5} data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  <Bar dataKey="contacted" fill="url(#contacted)" maxBarSize={10} radius={[5, 5, 0, 0]} />
                  <Bar dataKey="responded" fill="url(#responded)" maxBarSize={10} radius={[5, 5, 0, 0]} />
                  <Bar dataKey="completed" fill="url(#completed)" maxBarSize={10} radius={[5, 5, 0, 0]} />
                </BarChart>
              ) : (
                <LineChart data={data} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
                  ...
                  <Tooltip content={<CustomTooltip />} />
                  <Legend />
                  <Line type="linear" dataKey="contacted" stroke="#f26b50" strokeWidth={2} dot={{ stroke: '#f26b50', strokeWidth: 2, r: 4 }} />
                  <Line type="linear" dataKey="responded" stroke="#fcda6e" strokeWidth={2} dot={{ stroke: '#fcda6e', strokeWidth: 2, r: 4 }} />
