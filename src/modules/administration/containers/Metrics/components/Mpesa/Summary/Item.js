...
export default class Summary extends Component {
  ...
  componentWillReceiveProps(newProps) {
    ...
    if (statType !== newProps.statType) {
      this.setState({ statType: newProps.statType }, () => this.fetchMetric());
    }
  }

  async fetchMetric() {
    const { metricsActions, EventHandler, identifier, accountId, endpoint } = this.props;
    const { today, statType } = this.state;
