          ...
          <ResponsiveContainer>
            {
              chartType === 'bar' ? (
                <BarChart barCategoryGap={5} data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  <Legend />
                  <defs>
                    <linearGradient id="noOfTransaction" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <linearGradient id="amountReceived" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#a3d39c" stopOpacity={1} />
                      <stop offset="100%" stopColor="#a3d39c" stopOpacity={0.7} />
                    </linearGradient>
                  </defs>
                  <Bar dataKey="noOfTransaction" fill="url(#noOfTransaction)" maxBarSize={10} radius={[5, 5, 0, 0]} />
                  <Bar dataKey="totalAmount" fill="url(#totalAmount)" maxBarSize={10} radius={[5, 5, 0, 0]} />
                  <Bar dataKey="amountReceived" fill="url(#amountReceived)" maxBarSize={10} radius={[5, 5, 0, 0]} />
                </BarChart>
              ) : (
                <LineChart data={data} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
                  ...
                  <Tooltip content={<CustomTooltip />} />
                  <Legend />
                  <Line type="linear" dataKey="noOfTransaction" stroke="#f26b50" strokeWidth={2} dot={{ stroke: '#f26b50', strokeWidth: 2, r: 4 }} />
                  <Line type="linear" dataKey="totalAmount" stroke="#fcda6e" strokeWidth={2} dot={{ stroke: '#fcda6e', strokeWidth: 2, r: 4 }} />
                  <Line type="linear" dataKey="amountReceived" stroke="#a3d39c" strokeWidth={2} dot={{ stroke: '#a3d39c', strokeWidth: 2, r: 4 }} />
                </LineChart>
              )
            }
          </ResponsiveContainer>
