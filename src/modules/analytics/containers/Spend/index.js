...
import Trend from "../components/Spend";
...
const locationsPerformance = [
  {
    title: "Top Location",
    subtitle: "Which is my top performing branch?",
  ...
  },
  {
    ...
    subtitle: "Which is my least performing branch?",
    name: "Java - Karen",
    value: 800000,
    valueContextLeft: "KES",
    performance: -1.9,
...
const segmentsPerformance = [
  {
    title: "Top Segment",
    subtitle: "Which is my top performing segment?",
    name: "Nairobi",
    value: 678934758974,
    valueContextLeft: "KES",
    performance: 1.4,
  ...
  },
  {
    ...
    subtitle: "Which is my least performing segment?",
    name: "Mombasa",
    value: 56787,
    performance: -2.9,
    valueContextLeft: "KES",
...
const npsGroups = [
  {
    title: "Value of Promoters",
    subtitle: "What is the value of promoters?",
    name: "Promoters",
    value: 6006700,
    valueContextLeft: "KES",
    performance: 22.3,
  ...
  {
    title: "Value of Passives",
    subtitle: "What is the value of passives?",
    name: "Passives",
    value: 18007500,
    valueContextLeft: "KES",
    performance: -1.9,
  ...
  {
    title: "Value of Detractors",
    subtitle: "What is the value of detractors?",
    name: "Detractors",
    value: 7500,
    valueContextLeft: "KES",
    performance: -10.4,
...
class Spend extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      appliedFilters: [],
      npsGroupings: [],
      selectedPaymentMode: { key: "M-Pesa", label: "M-Pesa" },
      selectedDateRange: {
        key: 3,
        label: "Last 30 Days",
        value: {
  ...
  componentDidMount() {
    ...
    appActions.setRouteTitle("Spend");
    this.fetchNPSSummary();
    this.fetchSpendCustomerSpotlight();
  }
  ...
  async fetchSpendCustomerSpotlight() {
    ...
    try {
      const fetchSpendCustomerSpotlightResult = await customerAnalyticsActions.fetchSpendCustomerSpotlight({ startTime, endTime }, selectedSegment.id, appliedFilters);

      // console.log(fetchSpendCustomerSpotlightResult)
      ...
      // const npsGroupings = [
      //   { title: 'Value of Promoters', subtitle: 'What is the value of promoters?', name: 'Promoters', value: promoters, valueContextRight: 'customers', performance: 22.3, icon: 'sentiment_satisfied_alt', rangeDays: 30 },
      //   { title: 'Value of Passives', subtitle: 'What is the value of passives', name: 'Passives', value: passives , valueContextRight: 'customers', performance: -1.9, icon: 'sentiment_satisfied', rangeDays: 30 },
      //   { title: 'Value of Detractors', subtitle: 'What is the value of detractors?', name: 'Detractors', value: detractors, valueContextRight: 'customers', performance: -10.4, icon: 'sentiment_very_dissatisfied', rangeDays: 30 },
      // ];
    ...
    const customActions = [
      {
        ...
        options: [
          ...
          { key: "Cash", label: "Cash" },
          { key: "Card", label: "Card" },
          { key: "Mobile (Bank App)", label: "Mobile (Bank App)" },
          { key: "Other", label: "Others" }
        ],
        callback: this.onPaymentModeChange,
      ...
      >
        {configurations.features.customerAnalytics === null ? (
          ...
          >
            ...
            <span style={{ margin: 20 }}>Loading Customer Analytics</span>
          </div>
              ...
              <XMasonry>
                <XBlock key="highest-spender-comment" width={2}>
                  <HighestSpender
                    ...
                    subtitle="Who is my highest spending customer?"
                    comment={{
                ...
                <XBlock key="lowest-spender-comment" width={2}>
                  <HighestSpender
                    title="&nbsp;"
                    subtitle="Who is my lowest spending customer?"
                    comment={{
...
export default withAuthentication(Spend);
