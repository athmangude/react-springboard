...
const KeyValueListPlaceholder = ({ width }) => (
  <Col xl={4} lg={4} md={12} sm={12} xs={12} style={{ padding: width > 425 ? '0 10px 0 10px' : 0, borderRadius: 8 }}>
    <div style={{ width: '100%', height: 'calc(100% - 20px)', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', backgroundColor: '#ffffff', padding: 10, borderRadius: 8, boxShadow: '0 8px 20px 0 rgba(67, 70, 86, 0.1)', marginBottom: 20 }}>
