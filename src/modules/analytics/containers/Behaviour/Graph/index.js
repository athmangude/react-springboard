          ...
          <ResponsiveContainer>
            {
              chartType === 'bar' ? (
                <BarChart barCategoryGap={5} data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  <Legend />
                  <defs>
                    <linearGradient id="repeat" x1="0" y1="0" x2="0" y2="1">
                  ...
                  <Bar dataKey="repeat" fill="url(#repeat)" maxBarSize={10} radius={[5, 5, 0, 0]} />
                  <Bar dataKey="unique" fill="url(#unique)" maxBarSize={10} radius={[5, 5, 0, 0]} />
                </BarChart>
              ) : (
                <LineChart data={data} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
                  ...
                  <Tooltip content={<CustomTooltip />} />
                  <Legend />
                  <Line type="linear" dataKey="repeat" stroke="#c86dd7" strokeWidth={2} dot={{ stroke: '#c86dd7', strokeWidth: 2, r: 4 }} />
                  <Line type="linear" dataKey="unique" stroke="#b4ec51" strokeWidth={2} dot={{ stroke: '#b4ec51', strokeWidth: 2, r: 4 }} />
                </LineChart>
              )
            }
          </ResponsiveContainer>
